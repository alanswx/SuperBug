...
// Wed Apr 13 2022 19:46:52
//
//      Input file      : 
//      Component name  : k6_rom
//      Author          : 
//      Company         : 
//
//      Description     : 
...
module K6_ROM(
    ...
    assign q = sub_wire0[3:0];
    
    
    altsyncram #(.clock_enable_input_a("BYPASS"), .clock_enable_output_a("BYPASS"), .init_file("../roms/009125k6.hex"), .intended_device_family("Cyclone II"), .lpm_hint("ENABLE_RUNTIME_MOD=NO"), .lpm_type("altsyncram"), .numwords_a(1024), .operation_mode("ROM"), .outdata_aclr_a("NONE"), .outdata_reg_a("CLOCK0"), .widthad_a(10), .width_a(4), .width_byteena_a(1)) altsyncram_component(
        .address_a(address),
        .clock0(clock),
        .q_a(sub_wire0)
    );
