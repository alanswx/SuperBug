...
module ram256(
    ...
    altsyncram #(.clock_enable_input_a("BYPASS"), .clock_enable_output_a("BYPASS"), .intended_device_family("Cyclone II"), .lpm_hint("ENABLE_RUNTIME_MOD=NO"), .lpm_type("altsyncram"), .numwords_a(256), .operation_mode("SINGLE_PORT"), .outdata_aclr_a("NONE"), .outdata_reg_a("CLOCK0"), .power_up_uninitialized("FALSE"), .widthad_a(8), .width_a(4), .width_byteena_a(1)) altsyncram_component(
        .address_a(address),
        .clock0(clock),
        .data_a(data),
        .wren_a(wren),
