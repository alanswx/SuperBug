...
mkdir -p work
GHDL=ghdl
gcc -c -I/opt/homebrew/include $(sdl2-config --cflags) ghdl_access.c -o ghdl_access_c.o
...
${GHDL} -m -g -Pwork -Paltera_mf  --std=08 --ieee=synopsys --workdir=work --ieee=synopsys -Wl,ghdl_access_c.o -Wl,-L/opt/homebrew/lib -Wl,-lSDL2 top
